...
public class Item : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(no_gravity && DateTime.Now>endGravity){
            ...
            if(rb.gameObject.GetComponent<Rigidbody>().velocity.x==0.0 && rb.gameObject.GetComponent<Rigidbody>().velocity.y==0.0 && rb.gameObject.GetComponent<Rigidbody>().velocity.z==0.0 ){
